...
<div class="body-container" style="width: 700px;">
	...
	<div>
				...
				<c:forEach var="dto" items="${noticeList}">
					<tr align="center" bgcolor="#ffffff" height="35"
						...
						<td align="left" style="padding-left: 10px;"><a
							href="${articleUrl}&num=${dto.num}" style="font-weight: 900px;">${dto.subject}</a></td>
						<td>${dto.userName}</td>
						<td>${dto.created}</td>
						<td>${dto.hitCount}</td>
						<td><c:if test="${dto.fileCount!=0}">
					<a href="<%=cp%>/notice/zipDownload?num=${dto.num}">
		...
		<table style="width: 100%; border-spacing: 0px;">
			<tr height="35">
				<td align="center">${dataCount==0? "등록된 자료가 없습니다":paging}</td>
			</tr>
		</table>
			...
			<tr height="40">
				<td align="left" width="100">
					<button type="button" class="btn"
						onclick="javascript:location.href='<%=cp%>/notice/list';">새로고침</button>
				</td>
				<td align="center">
